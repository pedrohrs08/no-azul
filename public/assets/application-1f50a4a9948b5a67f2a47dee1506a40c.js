...
(function() { this.JST || (this.JST = {}); this.JST["finance_record"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<hr>\n   <div>');  date ; __p.push('</div>\n   <div>');  description ; __p.push('</div>\n   <div>');  value ; __p.push('/div>\n<hr>\n');}return __p.join('');};
}).call(this);
...
var FinanceRecordView = Backbone.View.extend({
	...
	className: function(){
		if(this.model.get("expense"))
			return 'finance-record-expense';
		else
			return 'finance-record-income';
	},
	financeTemplate: _.template(JST["finance_record"]),
	render: function(){
...
var Router = Backbone.Router.extend({
	...
	index: function(){
       ...
       $("#main").html(this.financeRecordsView.render().el);
	}
});
function Player() {
}
